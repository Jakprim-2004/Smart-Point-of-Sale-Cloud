...
ระบบ Point of Sale (POS) สำหรับธุรกิจขนาดเล็กถึงขนาดกลาง พัฒนาด้วยเทคโนโลยีล้ำสมัย React.js และ Node.js พร้อมฟีเจอร์ครบครันสำหรับการจัดการร้านค้าแบบครบวงจร
...
1. เปิดเบราว์เซอร์ไปที่ `http://localhost:3000/register` เพื่อสร้างบัญชี
2. เข้าสู่ระบบด้วยบัญชีที่สร้าง
